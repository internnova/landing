...
const colorClassnames = {
  primary:
    "bg-accent-primary transition duration-200 ease-in-out hover:bg-accent-primary-darker",
  inverted:
    "text-accent-primary bg-white transition duration-200 ease-in-out hover:bg-gray-700",
}
